...
with app.app_context():
    ...
    tristan_2021 = Review(
        year=2021, summary="Good coding skills, often late to work", employee=tristan
    )
    tristan_2022 = Review(
        year=2022, summary="Strong coding skills, takes long lunches", employee=tristan
    )
    tristan_2023 = Review(
        year=2023, summary="Awesome coding skills, dedicated worker", employee=tristan
    )
    ...
    uri_onboarding = Onboarding(
        orientation=datetime.datetime(2023, 3, 27), employee=uri
    )
